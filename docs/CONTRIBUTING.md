# Contributing to IDLEChain Project
...
posted to #idlechain-dev on irc.libera.chat).
...
The "IDLEChain Project Maintainer Team" is defined in this document as the following users:
- fluffypony
- idlechainmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to IDLEChain Project code or IDLEChain Project's dependency code or IDLEChain Project's potential/future dependency code or research which successfully implements IDLEChain Project.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the IDLEChain Project Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the IDLEChain Project Maintainer Team.
