...
RUN	git clone https://github.com/idlechain-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/idlechain-project/idlechain
...
if [ ! -d sigs ]; then
	git clone https://github.com/idlechain-project/gitian.sigs.git sigs
	cd sigs
